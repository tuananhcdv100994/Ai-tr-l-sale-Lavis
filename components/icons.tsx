...
export const UploadIcon = ({ className }: { className?: string }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 15H4.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 15h-4.5" />
...
export const BotIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path fillRule="evenodd" d="M4.5 3.75a3 3 0 00-3 3v10.5a3 3 0 003 3h15a3 3 0 003-3V6.75a3 3 0 00-3-3h-15zm4.125 3a2.25 2.25 0 100 4.5 2.25 2.25 0 000-4.5zm-3.875 3.75a.375.375 0 01.375-.375h2.25a.375.375 0 010 .75h-2.25a.375.375 0 01-.375-.375zM11.625 6.75a2.25 2.25 0 100 4.5 2.25 2.25 0 000-4.5zm6.375 3a.375.375 0 00.375.375h2.25a.375.375 0 000-.75h-2.25a.375.375 0 00-.375.375zM8.625 13.5a.375.375 0 01.375-.375h6.75a.375.375 0 010 .75h-6.75a.375.375 0 01-.375-.375z" clipRule="evenodd" />
    </svg>
);
...
export const ResetIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.664 0l3.18-3.185m-3.181 9.348a8.25 8.25 0 00-11.664 0l-3.18 3.185m3.181-9.348l-3.18-3.182m11.664 0l-3.18 3.183" />
    </svg>
);
